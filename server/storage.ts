...
export class MemStorage implements IStorage {
  ...
  async createPsiProduct(insertProduct: InsertPsiProduct): Promise<PsiProduct> {
    ...
    const product: PsiProduct = {
      ...
      contactEmail: insertProduct.contactEmail || null,
      contactPhone: insertProduct.contactPhone || null,
      location: insertProduct.location || null,
      latitude: insertProduct.latitude || null,
      longitude: insertProduct.longitude || null,
      shipsGlobally: insertProduct.shipsGlobally || false,
      localOnly: insertProduct.localOnly || false,
      fairTrade: insertProduct.fairTrade || false,
      organic: insertProduct.organic || false,
      handmade: insertProduct.handmade || false,
      biodegradable: insertProduct.biodegradable || false,
      transparentBusiness: insertProduct.transparentBusiness || false,
      noAds: insertProduct.noAds || false,
      openSource: insertProduct.openSource || false,
      communitySupported: insertProduct.communitySupported || false,
      verifiedSeller: false,
      qualityScore: "0",
      trustScore: "0",
      active: insertProduct.active !== false,
