...
export class MemStorage implements IStorage {
  ...
  async createPsiProduct(insertProduct: InsertPsiProduct): Promise<PsiProduct> {
    ...
    const product: PsiProduct = {
      ...
      shipsGlobally: insertProduct.shipsGlobally || null,
      localOnly: insertProduct.localOnly || null,
      fairTrade: insertProduct.fairTrade || null,
      organic: insertProduct.organic || null,
      handmade: insertProduct.handmade || null,
      biodegradable: insertProduct.biodegradable || null,
      transparentBusiness: insertProduct.transparentBusiness || null,
      noAds: insertProduct.noAds || null,
      openSource: insertProduct.openSource || null,
      communitySupported: insertProduct.communitySupported || null,
